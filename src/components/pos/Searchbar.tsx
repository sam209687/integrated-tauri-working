...
import { X, AlertCircle, CheckCircle, Scan, ShoppingCart, Calculator } from "lucide-react";
    ...
    <div className="flex flex-col h-full w-full bg-gray-900 rounded-lg p-4 relative">
      ...
      <div className="mb-4">
        ...
        >
          ...
          {/* Daily Billing Mode (Existing functionality) */}
          ...
          {/* Retail Billing Mode (New Component) */}
